...
const tracks = [
  ...
  },
  {
    ...
    image: fullstack,
    subhead: "Career Track",
    desc:"<ul><li><strong>Cost:</strong> 15% Income for 1 years. Capped: $9,000 via our <a href='/candidate-agreement'>deffered fee agreement</a><li><strong>Tracks:</strong> Part & Full-time.</li></ul><p align='center'><a  href='/learn/fasttrack'>Learn More</a></p>",
    color: "#290f34",
    category: 'career',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Frvd2ba%2Fview',
