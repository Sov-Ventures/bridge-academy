...
const tracks = [
  ...
  },
  {
    ...
    subhead: "~10hrs/week to complete in 3 months.",
    desc:"<ul><li><strong>Build:</strong> (6) hands-on mini-projects including: A Recipe Website, TODO List and your own capstone project.</li><li><strong>Learn:</strong> node, react, redux, mongo, git, graphql, continuous integration and serverless development.</li><li><strong>Cost:</strong> $600 up-front (or $110/mo for 6-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
  ...
  },
  {
    ...
    subhead: "~10hrs/week to complete in 3 months.",
    desc:"<ul><li><strong>Build:</strong> (6) hands-on mini-projects including: A customer churn predictor, exploratory data analyzer and your own capstone project.</li><li><strong>Learn:</strong> NumPy, Pandas, Seaborn, Matplotlib, Plotly, Scikit-Learn, Tensorflow + more.</li><li><strong>Cost:</strong> $600 up-front (or $110/mo for 6-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
  {
    ...
    subhead: "~10hrs/week to complete in 3 months.",
    desc:"<ul><li><strong>Build:</strong> (6) hands-on mini-projects including: Learn Continuous Integration, Continuous Delivery & 15 different DevOps tools.</li><li><strong>Learn:</strong> Docker, Ansible, Terraform, Jenkins, Chef, Puppet, Kubernetes and more.</li><li><strong>Cost:</strong> $600 up-front (or $110/mo for 6-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
