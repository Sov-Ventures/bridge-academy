...
const tracks = [
  {
    ...
    desc:"<ul><li><strong>Build:</strong> A DEX, a block explorer, a ethereum dApp or your own project idea in the monthly build challenge.</li><li><strong>Learn:</strong> State Channels, Snarks/Starks, Smart Contracts & Web3 + more.</li><li><strong>Cost:</strong> $499 up-front (or $110/mo for 5-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
  ...
  },
  {
    ...
    image: fullstack,
    subhead: "Join Monthly",
    desc:"<ul><li><strong>Build:</strong> A Smart-Recipe Website, TODO List or your own personal project in the monthly build challenge.</li><li><strong>Learn:</strong> node, react, redux, mongo, git, graphql, continuous integration and serverless development.</li><li><strong>Cost:</strong> $499 up-front (or $110/mo for 5-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
  ...
  },
  {
    ...
    image: datascience,
    subhead: "Join Monthly",
    desc:"<ul><li><strong>Build:</strong> A customer churn predictor, exploratory data analyzer or your own personal project in the monthly build challenge.</li><li><strong>Learn:</strong> NumPy, Pandas, Seaborn, Matplotlib, Plotly, Scikit-Learn, Tensorflow + more.</li><li><strong>Cost:</strong> $499 up-front (or $110/mo for 5-months) minus $100 rebate on completion.</li></ul>",
    color: "#096ff0",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
