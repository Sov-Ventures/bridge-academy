...
const jobs = [
  {
    ...
    desc:"<ul><li>Chorus One has working validators in Cosmos and Loom. We are actively searching for a Cryptoeconomic Fullstack Engineer to extend our services to other networks. The work consists of exploring codebases potential new crypto networks for potential economic and network vulnerabilities and exploits, ensuring operational security in deployed infrastructure, and external communications with network development teams.</li></ul>",
    color: "#096ff0",
    category: 'tech',
