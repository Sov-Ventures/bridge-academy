...
const tracks = [
  {
    ...
    desc:"<ul><li><strong>Ideas:</strong> A relayer for margin loans , a live volume infographic or your own project idea.</li><li><strong>Prizes:</strong> $1k, $500 and $250 for top 3 dapps.</li></ul>",
    color: "#F3764B",
    category: 'tech',
  ...
  },
  {
    ...
    desc:"<ul><li><strong>Ideas:</strong> A decentralized recipe site, a sybil resistant contact manager or your own idea.</li><li><strong>Prizes:</strong> $1k, $500 and $250 for top 3 dapps.</li></ul>",
    color: "#290f34",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  },
  {
    ...
    desc:"<ul><li><strong>Ideas:</strong> An rest API for ERC721 pricing, NFT Chrome extension or your own project idea.</li> <li><strong>Prizes:</strong> $1k, $500 and $250 for top 3 dapps.</li></li></ul>",
    color: "#fcfcfc",
    category: 'tech',
    link: 'https://apply.bridge.academy/register?next=%2Fb%2Fvqcdrz%2Fview',
  }
